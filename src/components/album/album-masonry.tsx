...
interface AlbumMasonryProps {
  ...
  onAlbumShare?: (album: AlbumVo) => void
...
// 渲染相册虚拟滚动列表。
export function AlbumMasonry({ albums, resetKey = 0, onAlbumRename, onAlbumTop, onAlbumVisibility, onAlbumShare, onAlbumDelete }: AlbumMasonryProps) {
