...
import { Library, MonitorCog, Image, Heart, LockKeyhole, Trash2, FolderOpen, Database, User, Settings } from "lucide-react"
...
export function AppSidebar({ ...props }: React.ComponentProps<typeof Sidebar>) {
  ...
  const data = {
    ...
    navMain: [
      ...
      { title: t("navigation.private"), url: "/private", icon: <LockKeyhole />, isActive: false },
